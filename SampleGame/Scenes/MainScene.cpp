...
namespace SampleGame {
    void SampleGame::MainScene::Load(Harpia::Application *application) {
        ...
        rend1->SetMaterial(LoadMaterialAsset(LoadShaderAsset(Harpia::Color(0.5f, 0, 0, 1))));
        ...
        rend2->SetMaterial(LoadMaterialAsset(LoadShaderAsset(Harpia::Color(0.0f, 0.5f, 0, 1))));
